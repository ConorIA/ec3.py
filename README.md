...
```
    ...
    ##                                          Name  ... MLY Last Year
    ## 6465  PA TORONTO INTERNATIONAL TRAP AND SKEET  ...           NaN
    ## 6472             PA TORONTO NORTH YORK MOTORS  ...           NaN
    ## 6476              PA SCARBOROUGH TORONTO HUNT  ...           NaN
    ## 6479                       PA TORONTO HYUNDAI  ...           NaN
    ## 6538                                  TORONTO  ...        2006.0
    ## 6539                  TORONTO SOLAR RADIATION  ...           NaN
    ## 6540                             TORONTO CITY  ...        2006.0
    ## 6541                      TORONTO CITY CENTRE  ...           NaN
    ## 6542                        TORONTO AGINCOURT  ...        1968.0
...
```
    ...
    ## 6582                   TORONTO ISLAND A  ONTARIO  ...         1957.0         2006.0
    ## 6592  TORONTO LESTER B. PEARSON INT'L A  ONTARIO  ...         1953.0         2013.0
    ## 
    ## [2 rows x 15 columns]
...
```
    ...
    ##                                 Name  ...                   Dist
    ## 6540                    TORONTO CITY  ...                 0.0 km
    ## 6539         TORONTO SOLAR RADIATION  ...                 0.0 km
    ## 6538                         TORONTO  ...                 0.0 km
    ## 6558               TORONTO DEER PARK  ...  1.9585072748345755 km
    ## 6478      PA MATTAMY ATHLETIC CENTRE  ...   1.958726710148121 km
    ## 6619              TORONTO SHERBOURNE  ...  3.2853644805861606 km
    ## 6463  PA DUFFERIN AND ST. CLAIR CIBC  ...  3.4116926360325173 km
    ## 6556               TORONTO BROADVIEW  ...  4.0324702425710255 km
    ## 6589               TORONTO LEASIDE S  ...   4.118383821538006 km
...
```
    ...
    ##                                      Name  ...                    Dist
    ## 6480  PA U OF T SCARBOROUGH TENNIS CENTRE  ...  0.46772058790516413 km
    ## 6617              TOR SCARBOROUGH COLLEGE  ...    0.736729501436302 km
    ## 6577               TORONTO HIGHLAND CREEK  ...   1.4706493130818032 km
    ## 6615                    TORONTO WEST HILL  ...    2.082271174320758 km
    ## 6594                      TORONTO MALVERN  ...    3.865321295320793 km
    ## 6557                  TORONTO CURRAN HALL  ...     3.88797634214092 km
    ## 6596                    TORONTO METRO ZOO  ...    4.067153857612105 km
    ## 6511                          ROUGE HILLS  ...    4.965652205701927 km
    ## 
    ## [8 rows x 20 columns]
...
```
    ...
    ## Station 48549 : TORONTO CITY CENTRE (2010-2019)
    ## 
    ## 
    ##          Name Province Climate ID  ...  DLY First Year  DLY Last Year    Dist
    ## 6538  TORONTO  ONTARIO    6158350  ...          1840.0         2017.0  0.0 km
    ## 
    ## [1 rows x 16 columns]
